...
# --- Configurações ---
MODEL_PATH = "/home/victor_santiago/Documentos/online-coding-for-blinds/models/qwen2-1_5b-instruct-q4_0.gguf"
...
print("Carregando o modelo GPT4All para geração (Qwen2)...")
...
# --- Configurações RAG ---
INDEX_DIR = "../../faiss_indexes/qwen2_explainer"
...
def gerar_feedback_egua_local(
    ...
    print("Gerando feedback com GPT4All (Qwen2)...")
    try:
